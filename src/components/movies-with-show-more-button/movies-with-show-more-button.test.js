...
import MoviesWithShowMoreButton from "./movies-with-show-more-button";
...
it(`MoviesWithShowMoreButton is rendered correctly`, () => {
  const tree = renderer.create(
      <BrowserRouter>
        <MoviesWithShowMoreButton movies={[movie]} currentStep={0} limit={2} onButtonClick={noop} showButton={true} />
      </BrowserRouter>
  ).toJSON();
